...
import {
  ...
  type StreamableValue as BaseStreamableValue,
} from "ai/rsc";
import type { BamlStream } from "@boundaryml/baml";
import { b } from "@/baml_client";

export const chat = makeStreamable(b.stream.Chat.bind(b.stream));
export const extractResume = makeStreamable(
  b.stream.ExtractResume.bind(b.stream)
);
